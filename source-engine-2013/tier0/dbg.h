...
static void   _SpewInfo( SpewType_t type, const tchar* pFile, int line ) {}
static SpewRetval_t   _SpewMessage( PRINTF_FORMAT_STRING const tchar* pMsg, ... ) FMTFUNCTION( 1, 2 ) { return SPEW_CONTINUE; }
...
DBG_INTERFACE void _AssertValidStringPtr( const tchar* ptr, int maxchar = 0xFFFFFF );
static void AssertValidStringPtr( const tchar* ptr, int maxchar = 0xFFFFFF ) { _AssertValidStringPtr(ptr, maxchar); }
